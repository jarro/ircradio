...
public class User implements Comparable{
    ...
    public int compareTo(Object o) {
        if (o instanceof User) {
            ...
            int result;
            if (_prefix.equals("@") && other._prefix.equals("@")) {              
              result = (_lowerNick).compareTo(other._lowerNick);
            }else if (_prefix.equals("@")) { 
              result = -1;
            }else if (other._prefix.equals("@")){
              result = 1;
            }else{
              result = (_prefix + _lowerNick).compareTo(other._prefix + other._lowerNick);	
            }
