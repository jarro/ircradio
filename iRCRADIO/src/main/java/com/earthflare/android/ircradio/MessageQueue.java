...
public enum MessageQueue {
	...
	public void standardMessage(MessageBundle mb) {
		
		//abort while phone in use
		if (Globo.phonebusystate) {return;}
	...
	public void privateMessage(MessageBundle mb) {
	...
	public void actionMessage(MessageBundle mb) {
